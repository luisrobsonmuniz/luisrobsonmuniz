...
* **Análise de Requisitos e Arquitetura Cognitiva Aplicada:** Capacidade sênior de aplicar a engenharia de fluxos pedagógicos para transformar rotinas complexas e relatos verbalizados subjetivos em requisitos lógicos de software, estruturando soluções de inteligência artificial que expandem a eficiência operacional escolar sem perder a humanidade.
* **Visão Sistêmica e ESG:** Discernimento crítico para desenhar indicadores de sustentabilidade institucional, auditar métricas organizacionais e aplicar diagnósticos de eficiência e gestão de recursos em ambientes educacionais.
